...
public interface ProcurementRepository extends JpaRepository<Procurement, Long> {
    ...
    @Query("SELECT p FROM Procurement p WHERE p.status = ru.thelper.models.BaseStatus.ACTIVE AND  p.applicationDeadline > :prevTime AND p.applicationDeadline < :nextTimeEvent")
