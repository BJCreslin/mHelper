...
import ru.thelper.models.objects.UserTextPair;
...
import ru.thelper.services.user_event.create_message.CreateMessage;
import ru.thelper.services.user_event.users_list.UsersListGet;
